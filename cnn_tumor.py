...
image_dir='deep-learning\\CNN\\tumor_detection\\tumordata'
...
plt.savefig('deep-learning\\CNN\\tumor_detection\\results\\tumor_sample_accuracy_plot.png')
...
plt.savefig('deep-learning\\CNN\\tumor_detection\\results\\tumor_sample_loss_plot.png')
...
model.save('deep-learning\\CNN\\tumor_detection\\results\\model\\cnn_tumor.h5')
...
make_prediction(cv2.imread('deep-learning\\CNN\\tumor_detection\\tumordata\\yes\\y6.jpg'),model)
print("--------------------------------------\n")
make_prediction(cv2.imread('deep-learning\\CNN\\tumor_detection\\tumordata\\no\\no1493.jpg'),model)
print("--------------------------------------\n")
